...
exports = module.exports = function(config) {
    return function (req, res, next) {
        Object.defineProperty(req, "session", { value : new session(req, res, config),  writable : false, configurable : false, enumerable : false  });
        next();
    }
}
...
var session = function ( req, res, option) {
    ...
    this.id = function () {
       ...
       return _id = params(config['id'],config['key']);
    }
