...
const ObjectID  = library('ObjectID');
...
exports = module.exports = function(opts){
    ...
    mergeOpts['crypto'] = library('crypto')(mergeOpts.secret,6);
...
function session(req,res,option) {
    ...
    Object.defineProperty(this,'crypto',{ value: option.crypto, writable: false, enumerable: false, configurable: false,});
...
function session_create(req,res,uid,data,callback) {
    var self = this,sid;
    if(this.option.guid){
        this.uid = sid = ObjectID().toString();
    }
    else{
        this.uid = uid;
