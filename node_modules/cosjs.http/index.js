...
function handle_call(req,res,next){
    ...
    if(usrAgent.session && usrAgent.session.cosjs){
        var session_start_bind = session_start_callback.bind(usrAgent,method);
        usrAgent.session.start(session_start_bind,path);
    }
    else{
...
handle_prototype.prototype.render = function(err,ret){
    var self = this;
