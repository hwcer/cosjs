...
function cosjsTime(DAYRESET){
    if (!(this instanceof cosjsTime)) {
        return new cosjsTime(DAYRESET)
    }

    this.week = function(){
        return exports.week(DAYRESET);
    }

    this.today = function(){
        return exports.today(DAYRESET);
    }

    this.expire = function(stime,days){
        return exports.expire(stime,days,DAYRESET);
    }

    this.sign = function(time){
        return exports.sign(time,DAYRESET);
    }

    this.format = exports.format;
}
exports = module.exports = cosjsTime;

//本周开始时间
exports.week = function(DAYRESET){
    DAYRESET = DAYRESET || 0;
    var DAYRESETMS = DAYRESET * 3600 * 1000;
...
//每日时间标签
exports.sign = function(time,DAYRESET){
    DAYRESET = DAYRESET || 0;
    var DAYRESETMS = DAYRESET * 3600 * 1000;
