...
exports = module.exports = function(RedisKey,PrefixChar,FormatOpts){
    return new redis_hash(RedisKey,PrefixChar,FormatOpts);
}
...
class redis_hash extends base{
    ...
    set(id, key) {
        ...
        callback = (typeof arguments[next] === 'function') ? arguments[next] : this.callback;
