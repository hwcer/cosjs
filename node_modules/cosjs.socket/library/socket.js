...
exports = module.exports = function socket_server(opts){
    ...
    if(opts.emitter){
        if (opts.emitter instanceof (library("emitter"))) {
            app.emitter = opts.emitter;
        }
        else{
            app.emitter = library("emitter")(opts.emitter,app);
        }
    ...
    if( opts['refresh'] && app.emitter ){
        setInterval(function(){
            app.emitter.emit('connector',{host:opts.host,port:opts.port,maxClient:opts.maxClient,online:opts.online});
        },opts['refresh']);
    }
