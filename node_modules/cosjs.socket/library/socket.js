...
//connector
exports = module.exports = function socket_server(root,opts,emitter){
    ...
    app.on('connection', function (socket) {
        ...
        var handle_call_bind = handle_call.bind(socket_handle);
    ...
    if( opts['refresh'] && app.emitter ){
        setInterval(function(){
            app.emitter.emit('connector',{host:opts.host,port:opts.port,maxClient:opts.maxClient,online:app.online});
        },opts['refresh']);
    }
