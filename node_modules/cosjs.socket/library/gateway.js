...
exports = module.exports = function(opts){
    var port = opts.port;
    var emitOpts = Object.assign({},opts.emitter);
    emitOpts['root'] = null;
    emitOpts['pattern'] = false;
    var emitter = library("emitter")(emitOpts);
    var application  = require('socket.io')(port,opts);
    ...
    //监控connector list变化
    emitter.on('connector',function(opts){
        var key = [opts.host,opts.port].join(':');
        opts['zone'] = 0;
